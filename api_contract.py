...
SPEC = {
  ...
  "/app/publish/providers":  ("GET", "مصادَق", "—",
      "كلُّ منصّةٍ بحالتها: ready | not_implemented", "—"),
  "/app/publish/accounts":   ("GET", "مصادَق", "—",
      "الحساباتُ المربوطة — بلا أسرار، تلميحٌ من أربعةِ محارف", "—"),
  "/app/publish/attempts":   ("GET", "مصادَق", "—",
      "سجلُّ محاولات النشر — بلا أسرار", "—"),
  "/app/publish/connect":    ("POST", "مصادَق", "provider, secret, label",
      "الحسابُ المربوط + تلميح", "400 منصّةٌ غيرُ منفَّذةٍ أو اعتمادٌ قصير"),
  "/app/publish/disconnect": ("POST", "مالك", "account",
      "{disconnected}", "404 ليس حسابَك"),
